# AXLearn - The AXLearn Library for Deep Learning. This library is under active development and the API is subject to change.
...
cd axlearn
(Optional) We recommend installing within a virtual environment, e.g. with conda:
