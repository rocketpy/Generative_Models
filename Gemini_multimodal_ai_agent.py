# Original - https://github.com/Shubhamsaboo/awesome-llm-apps/blob/main/starter_ai_agents/gemini_multimodal_agent_demo/multimodal_ai_agent.py
import time
...
agent.print_response(query, images=[image_url], 
                     audio=audio_file, videos=[video_file], stream=True)
